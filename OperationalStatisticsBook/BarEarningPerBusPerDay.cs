...
namespace WindowsFormsApp1
{
    public partial class BarEarningPerBusPerDay : Form
    {
        ...
        public BarEarningPerBusPerDay(int OsbId, int Year, int Month, string finYear, string MonthName)
        {
            InitializeComponent();
            this.OsbId = OsbId;
            this.Year = Year;
        ...
        private void BarEarningPerBusPerDay_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource datasource = new ReportDataSource("BarEarningPerBusPerDay", dtReportData);
