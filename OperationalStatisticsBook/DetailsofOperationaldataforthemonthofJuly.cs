    ...
    public partial class DetailsofOperationaldataforthemonthofJuly : Form
    {
        ...
        void CalcalculateTotal()
        {
            ...
            for (int i = 3; i < 19; i++)
            {
                ...
                dataGridView1.Rows[10].Cells[i].Value = Common.GetDiv(row, 8, 9, i);

                //Missed kms
                dataGridView1.Rows[14].Cells[i].Value = Math.Round(Common.ConvertToDecimal(row[12].Cells[i].Value.ToString()) - Common.ConvertToDecimal(row[13].Cells[i].Value.ToString()), 2);

                // (a) Avg buses on Road kms/bus/day Start
                dataGridView1.Rows[18].Cells[i].Value = Common.ConvertToDecimal(row[6].Cells[i].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[16].Cells[i].Value.ToString()) * 100000) / Common.ConvertToDecimal(row[6].Cells[i].Value.ToString())) : 0;

                // (b) Avg buses on Road kms/bus/day Start
                dataGridView1.Rows[19].Cells[i].Value = Common.ConvertToDecimal(row[3].Cells[i].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[16].Cells[i].Value.ToString()) * 100000) / Common.ConvertToDecimal(row[3].Cells[i].Value.ToString())) : 0;

                // Total Ticket Earning  Start
                dataGridView1.Rows[24].Cells[i].Value = Math.Round(Common.GetSum(row, 22, 23, i), 2);

                // Total Grand Total  Start
                dataGridView1.Rows[26].Cells[i].Value = Math.Round(Common.GetSum(row, 24, 25, i), 2);

                // 20 B Excluding passenger tax
                dataGridView1.Rows[32].Cells[i].Value = Common.ConvertToDecimal(row[16].Cells[i].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[29].Cells[i].Value.ToString()) * 100) / Common.ConvertToDecimal(row[16].Cells[i].Value.ToString())) : 0;

                // Total Ticket  Start
                dataGridView1.Rows[37].Cells[i].Value = Math.Round(Common.GetSum(row, 35, 36, i), 2);

                // Grand Total  Start
                dataGridView1.Rows[39].Cells[i].Value = Math.Round(Common.GetSum(row, 37, 38, i), 2);

                // 24 Passengers per bus daily  column number 23*100000/ row number 5
                dataGridView1.Rows[41].Cells[i].Value = Common.ConvertToDecimal(row[6].Cells[i].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[40].Cells[i].Value.ToString()) * 100000) / Common.ConvertToDecimal(row[6].Cells[i].Value.ToString())) : 0;
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                if (i > 1)
                {
                    ...
                    dataGridView1.Rows[31].Cells[8].Value = Common.ConvertToDecimal(row[13].Cells[8].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[8].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[8].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[9].Value = Common.ConvertToDecimal(row[13].Cells[9].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[9].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[9].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[10].Value = Common.ConvertToDecimal(row[13].Cells[10].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[10].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[10].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[11].Value = Common.ConvertToDecimal(row[13].Cells[11].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[11].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[11].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[12].Value = Common.ConvertToDecimal(row[13].Cells[12].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[12].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[12].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[13].Value = Common.ConvertToDecimal(row[13].Cells[13].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[13].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[13].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[14].Value = Common.ConvertToDecimal(row[13].Cells[14].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[14].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[14].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[15].Value = Common.ConvertToDecimal(row[13].Cells[15].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[15].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[15].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[16].Value = Common.ConvertToDecimal(row[13].Cells[16].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[16].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[16].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[17].Value = Common.ConvertToDecimal(row[13].Cells[17].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[17].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[17].Value.ToString())) * 100) : 0;
                    dataGridView1.Rows[31].Cells[18].Value = Common.ConvertToDecimal(row[13].Cells[18].Value.ToString()) > 0 ? Math.Round((Common.ConvertToDecimal(row[26].Cells[18].Value.ToString()) / Common.ConvertToDecimal(row[13].Cells[18].Value.ToString())) * 100) : 0;
                    // column Number 20 (A)
                    ...
                    dataGridView1.Rows[45].Cells[3].Value =   Common.ConvertToDecimal(row[13].Cells[3].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[3].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[3].Value.ToString()) * 100000)), 2) : 0;
                    dataGridView1.Rows[45].Cells[6].Value =   Common.ConvertToDecimal(row[13].Cells[6].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[6].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[6].Value.ToString()) * 100000)), 2) : 0;
                    dataGridView1.Rows[45].Cells[4].Value =   Common.ConvertToDecimal(row[13].Cells[4].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[4].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[4].Value.ToString()) * 100000)), 2) : 0;
                    dataGridView1.Rows[45].Cells[7].Value =   Common.ConvertToDecimal(row[13].Cells[7].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[7].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[7].Value.ToString()) * 100000)), 2) : 0;
                    dataGridView1.Rows[45].Cells[8].Value =   Common.ConvertToDecimal(row[13].Cells[8].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[8].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[8].Value.ToString()) * 100000)), 2) : 0;
                    dataGridView1.Rows[45].Cells[9].Value =   Common.ConvertToDecimal(row[13].Cells[9].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[9].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[9].Value.ToString()) * 100000)), 2) : 0;
                    dataGridView1.Rows[45].Cells[5].Value =   Common.ConvertToDecimal(row[13].Cells[5].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[5].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[5].Value.ToString()) * 100000)), 2) : 0;
                    dataGridView1.Rows[45].Cells[10].Value = Common.ConvertToDecimal(row[13].Cells[10].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[10].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[10].Value.ToString()) * 100000) ), 2) : 0;
                    dataGridView1.Rows[45].Cells[11].Value = Common.ConvertToDecimal(row[13].Cells[11].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[11].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[11].Value.ToString()) * 100000) ), 2) : 0;
                    dataGridView1.Rows[45].Cells[12].Value = Common.ConvertToDecimal(row[13].Cells[12].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[12].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[12].Value.ToString()) * 100000) ), 2) : 0;
                    dataGridView1.Rows[45].Cells[13].Value = Common.ConvertToDecimal(row[13].Cells[13].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[13].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[13].Value.ToString()) * 100000) ), 2) : 0;
                    dataGridView1.Rows[45].Cells[14].Value = Common.ConvertToDecimal(row[13].Cells[14].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[14].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[14].Value.ToString()) * 100000) ), 2) : 0;
                    dataGridView1.Rows[45].Cells[15].Value = Common.ConvertToDecimal(row[13].Cells[15].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[15].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[15].Value.ToString()) * 100000) ), 2) : 0;
                    dataGridView1.Rows[45].Cells[16].Value = Common.ConvertToDecimal(row[13].Cells[16].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[16].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[16].Value.ToString()) * 100000) ), 2) : 0;
                    dataGridView1.Rows[45].Cells[17].Value = Common.ConvertToDecimal(row[13].Cells[17].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[17].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[17].Value.ToString()) * 100000) ), 2) : 0;
                    dataGridView1.Rows[45].Cells[18].Value = Common.ConvertToDecimal(row[13].Cells[18].Value.ToString()) > 0 ?  Math.Round( ( (Common.ConvertToDecimal(row[44].Cells[18].Value.ToString()) * 10000) / (Common.ConvertToDecimal(row[13].Cells[18].Value.ToString()) * 100000) ), 2) : 0;
