...
namespace WindowsFormsApp1
{
    public partial class rptIndexPrint : Form
    {
        ...
        public rptIndexPrint(int OsbId, int Year, int Month, string finYear, string MonthName)
        {
            InitializeComponent();
            this.OsbId = OsbId;
            this.Year = Year;
        ...
        private void rptIndexPrint_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource datasource = new ReportDataSource("rptIndexPrintPage", dtReportData);
