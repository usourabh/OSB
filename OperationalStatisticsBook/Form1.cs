...
namespace OperationalStatisticsBook
{
    public partial class frmOSBMain : Form
    {
        ...
        DataTable BindMasterData()
        {
            ...
            dt.Rows.Add("1.7", "Price and cost indices (" + GlobalMaster.FinMaster[6].FinVal + " to " + GlobalMaster.FinMaster[2].FinVal + ")", "8");
            dt.Rows.Add("1.8", "Material consumption (" + GlobalMaster.FinMaster[3].FinVal + " to " + GlobalMaster.FinMaster[1].FinVal + ")", "8");
            dt.Rows.Add("1.9", "Performance of Metropolitan Transport Undertakings (" + GlobalMaster.FinMaster[6].FinVal + ")", "9");
            dt.Rows.Add("1.10", "Accidents and compensation given to accidents victims (" + GlobalMaster.FinMaster[10].FinVal + " to " + GlobalMaster.FinMaster[1].FinVal + ")", "9");
            ...
            dt.Rows.Add("", "Depot wise Operational data (Non AC CNG, AC CNG, AC Electric Low floor buses DTC)", "");
            ...
            dt.Rows.Add("4.6", "Depot wise operational data ", "26");
            dt.Rows.Add("4.7", "Trips operated on time and  within two minutes.", "27");
            dt.Rows.Add("4.8", "Missed KMs and Breakdowns", "28");
            dt.Rows.Add("", "Accident Analysis", "");

            dt.Rows.Add("5.1", "Analysis of causes of accidents ", "29");
            dt.Rows.Add("5.2", "Other party involvement in Accidents ", "29");
            dt.Rows.Add("5.3", "Analysis of accidents by drivers (Age-Group)", "29");
    
            dt.Rows.Add("", "Miscellaneous Statistics", "");
            dt.Rows.Add("6.1", "Category wise sale of passes", "30-31");
            ...
            dt.Rows.Add("", "Traffic Earning PAI & Expenditure PAI ", "46");
