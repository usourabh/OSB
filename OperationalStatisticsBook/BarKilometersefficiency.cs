...
namespace WindowsFormsApp1
{
    public partial class BarKilometersefficiency : Form
    {
        ...
        public BarKilometersefficiency(int OsbId, int Year, int Month, string finYear, string MonthName)
        {
            InitializeComponent();
            this.OsbId = OsbId;
            this.Year = Year;
        ...
        private void BarKilometersefficiency_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource datasource = new ReportDataSource("BarKilometersefficiency", dtReportData);
