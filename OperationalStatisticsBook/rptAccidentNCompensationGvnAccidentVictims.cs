...
{
    public partial class rptAccidentNCompensationGvnAccidentVictims : Form
    {
        int OsbId = 0;
        int Year = 0;
        int Month = 0;
        ...
        public rptAccidentNCompensationGvnAccidentVictims(int OsbId, int Year, int Month, string finYear, string MonthName)
        {
            InitializeComponent();
            this.OsbId = OsbId;
            this.Year = Year;
        ...
        private void rptAccidentNCompensationGvnAccidentVictims_Load(object sender, EventArgs e)
        {
