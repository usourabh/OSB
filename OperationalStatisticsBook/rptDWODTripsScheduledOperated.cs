...
{
    public partial class rptDWODTripsScheduledOperated : Form
    {
        int OsbId = 0;
        int Year = 0;
        int Month = 0;
        ...
        public rptDWODTripsScheduledOperated(int OsbId, int Year, int Month, string finYear, string MonthName)
        {
            InitializeComponent();
            this.OsbId = OsbId;
            this.Year = Year;
