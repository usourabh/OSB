...
{
    public partial class rptStatementOfForTheMonthOfPasses : Form
    {
        int OsbId = 0;
        int Year = 0;
        int Month = 0;
        ...
        public rptStatementOfForTheMonthOfPasses(int OsbId, int Year, int Month, string finYear, string MonthName)
        {
            InitializeComponent();
            this.OsbId = OsbId;
            this.Year = Year;
        ...
        private void rptStatementOfForTheMonthOfPasses_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource datasource = new ReportDataSource("rptStatementOfForTheMonthOfPasses", dtReportData);
