...
namespace OperationalStatisticsBook
{
    public partial class MainDashboard : Form
    {
        ...
        DataTable BindMasterData()
        {
            ...
            dt.Rows.Add("1.1", "Analysis of causes of Accidents (2020-21 to 2021-22)", "analysisOfCausesAccidents");
            ...
            dt.Rows.Add("1.4", "Comparative Financial Results Year 2018-19 to 2020-21", "ComparativeFinancialResultsFrom");
            dt.Rows.Add("1.5", "Comparative operational data for the period (April to March) 2018-19 to 2020-21", "ComparativeOperationalData");
            ...
            dt.Rows.Add("1.7", "PRICE AND COST INDICES (2015-16 to 2019-20)", "PriceAndCostIndicies");
            dt.Rows.Add("1.8", "Material Consumption from 2018-19 to 2020-21", "MaterialConsumptionFrom");
            dt.Rows.Add("1.9", "Performance of Metopolitan Transport Undertaking", "PerformanceMetopolitanTransportUndertaking");
            dt.Rows.Add("1.10", "Accidents and Compensation given to Accident Victims April to March (2011-12 to 2020-21)", "AccidentNCompensationGvnAccidentVictims");
